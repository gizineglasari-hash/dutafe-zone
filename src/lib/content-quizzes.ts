...
export const QUIZ_M2: Record<"SMP" | "SMA", QuizQuestion[]> = {
  ...
  SMA: [
    ...
    { q: "WIFAS (Weekly Iron-Folic Acid Supplementation) berarti pemberian TTD...", options: ["1 tablet per hari", "1 tablet per minggu sepanjang tahun ajaran", "3 tablet sehari saat menstruasi", "2 tablet sebulan"], answer: 1, explain: "Untuk pencegahan (bukan pengobatan), dosisnya 1 tablet/minggu. Untuk remaja yang sudah terdiagnosis anemia: dosis terapi dikonsultasikan dengan tenaga kesehatan." },
...
export const QUIZ_FINAL: QuizQuestion[] = [
  ...
  { q: "Mengapa program TTD sekolah diberikan 1x SEMINGGU, bukan setiap hari?", options: ["Untuk pencegahan pada remaja dengan Hb normal, 1x/minggu cukup efektif; dosis harian adalah terapi bagi yang sudah anemia", "Karena tabletnya mahal", "Agar siswa tidak bosan", "Tidak ada alasan khusus"], answer: 0, explain: "WIFAS 1 tablet/minggu adalah dosis pencegahan. Remaja yang terdiagnosis anemia mendapat terapi — dosisnya dikonsultasikan dengan tenaga kesehatan." },
